...
export const metadata: Metadata = {
  title: 'Land Clearing & Land Management Services',
  description: 'Land clearing, forestry mulching, bush hogging, hunting land maintenance, grading, drainage, gravel driveways, firebreaks, and firelanes in East Alabama.',
  ...
  return (
    <>
      <section className="relative overflow-hidden bg-brand-forest py-20 text-white sm:py-28">
        <Photo src="/media/dozer-land-clearing.webp" alt="Dozer clearing and preparing land in East Alabama" fill priority sizes="100vw" className="object-cover opacity-35" />
        ...
        <div className="container-shell relative grid items-center gap-10 lg:grid-cols-[1fr_360px]">
          ...
          <Photo src="/brand/rhino-stacked.png" alt="Rhino Landwork stacked logo" width={1254} height={1254} sizes="320px" className="hidden w-full max-w-xs justify-self-end bg-white/95 p-4 shadow-2xl lg:block" />
        </div>
      </section>
      ...
      <section className="section-space">
        <div className="container-shell">
          <div className="max-w-3xl">
            ...
            <p className="mt-5 text-lg leading-8 text-slate-600">These are separate Rhino Landwork projects showing forestry mulching, drainage installation, and gravel driveway work in the field.</p>
          </div>
          <div className="mt-10 grid gap-4 md:grid-cols-3">
            <figure className="project-frame"><Photo src="/media/forestry-mulching-jobsite.webp" alt="Tracked forestry mulcher clearing vegetation from a wooded property" width={1920} height={1440} sizes="(max-width: 768px) 100vw, (max-width: 1280px) 33vw, 420px" className="h-[430px] w-full object-cover" /><figcaption className="image-label">Forestry mulching</figcaption></figure>
            <figure className="project-frame"><Photo src="/media/culvert-drainage-installation.webp" alt="Culvert pipe installation for property drainage" width={1920} height={1440} sizes="(max-width: 768px) 100vw, (max-width: 1280px) 33vw, 420px" className="h-[430px] w-full object-cover" /><figcaption className="image-label bg-brand-gold text-brand-ink">Drainage installation</figcaption></figure>
            <figure className="project-frame"><Photo src="/media/gravel-driveway-installation.webp" alt="Completed gravel driveway installation on a rural property" width={1920} height={1440} sizes="(max-width: 768px) 100vw, (max-width: 1280px) 33vw, 420px" className="h-[430px] w-full object-cover" /><figcaption className="image-label">Gravel driveway</figcaption></figure>
          </div>
        </div>
      </section>
    </>
