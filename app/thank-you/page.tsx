  ...
  return (
    <section className="section-space bg-brand-cream">
      <div className="container-shell max-w-3xl text-center">
        ...
        <p className="mx-auto mt-6 max-w-xl text-lg leading-8 text-slate-600">Your project details have been sent. Rhino Landwork will follow up to discuss the property and next steps.</p>
